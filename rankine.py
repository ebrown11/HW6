...
class rankine():
    ...
    def calc_efficiency(self):
        ...
        if(self.t_high==None):
            ...
            self.state1 = self.state1 = steam(self.p_high, T=self.t_high, name='Turbine Inlet') # instantiate a steam object with conditions of state 1 at t_high, named 'Turbine Inlet'
...
def main():
    rankine1 = rankine(t_high=550, name='Superheated Rankine Cycle') #instantiate a rankine object to test it.
    #t_high is specified
